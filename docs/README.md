...
This README provides a quick overview and navigation for OctoAcme's project management processes. It lists and links all documents in the `docs/` folder, so new and existing team members can quickly find everything they need.

## OctoAcme Project Management — Brief Summary
...
Quality assurance practices are embedded throughout the project lifecycle. This includes unit tests for new logic, integration tests where applicable, end-to-end smoke tests for critical flows, and security scanning in CI. The execution workflow emphasizes small pull requests, clear acceptance criteria, and at least one approval before merging. Regular retrospectives help teams continuously improve their processes by capturing what went well, what could be improved, and tracking action items with clear ownership.
...
> **Note for Team Members:** This README centralizes entry points to all project management documentation, clarifies our approach, and speeds onboarding for new team members. Please keep this README updated as new process docs are added to the `docs/` folder.
